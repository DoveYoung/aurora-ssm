	...
	<body id="comfirm-body" class="payway-body">
		...
		<div class="payway-box">
			<div class="order">
				<h1>
					...
					<i>订单处理成功请尽快付款，订单编号： ${payOrderID}</i>
				...
				<div class="code-box">
					<img src="../static/assets/img/blank.gif" data-echo="../wxMergePay/payment?payOrderID=${payOrderID}" id="QRcode" payOrderID="${payOrderID}"/>
		...
		<script>
			...
			$(document).ready(function() {
				var n = 1;
				var payOrderID = $('#QRcode').attr('payOrderID');
				(function poll() {
				    setTimeout(function() {
				        $.ajax({
				            url: 'query',
...
//				            timeout: 1000,
				            success: function(data) {
				               	if(data.state == 'success'){
				               		window.location.href = "../pay/goPaySuccess?payOrderID="+payOrderID;
