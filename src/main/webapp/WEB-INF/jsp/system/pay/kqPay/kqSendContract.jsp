...
<%
	...
	String bgUrl = "https://www.aurorascm.com/kqpayContract/goKQReceive";
	//网关版本，固定值：v2.0,该参数必填。
	String version =  "v2.0";
	...
	String orderId = request.getParameter("contractID");
	//订单金额，金额以“分”为单位，商户测试以1分测试即可，切勿以大金额测试。该参数必填。
	//String orderAmount = "1";
	String orderAmount = request.getAttribute("orderAmount").toString();
	// signMsg 签名字符串 不可空，生成加密签名串(不为空的所有参数进行拼接,为空的不参与)
	String signMsgVal = "";
